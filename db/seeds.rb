...
DailyNote.create(coffee_notes: "4 pots sold. Rwanda on drip", needs: "Nothing", items_86ed: "Stocked", pastry_soldout: true, leftover_pastry: "N/A", miscellaneous: "Good day for pastry", created_on: Time.new(2022, 7, 8, 2, 3, 2, "-05:00"), employee_id: e4.id )
DailyNote.create(coffee_notes: "Rwanda on left grinder. Philippines on right.", needs: "Cold coffee cans", items_86ed: "Philippines retail", pastry_soldout: true, leftover_pastry: "N/A", miscellaneous: "Cold coffee cans low", created_on: Time.new(2022, 7, 03, 4, 0, 2, "-05:00"), employee_id: e6.id )
DailyNote.create(coffee_notes: "People were really loving the cold coffee", needs: "Nada", items_86ed: "Nada", pastry_soldout: false, leftover_pastry: "1 croissant", miscellaneous: nil, created_on: Time.new(2021, 8, 14, 6, 4, 2, "-05:00"), employee_id: e4.id )
